  ...
  return (
    <>
      ...
      <section className="padding20 secc80">
        ...
        <h2 style={{ padding: "20px 0" }}>Contamos con diferentes tamaños de lotes para adaptarse a tus necesidades.</h2>
        <p>
      ...
      <section className="secc80">
        <h1 style={{textAlign:"center", padding:"50px 0", paddingBottom:"20px"}}>¿Listo para empezar?</h1>
        <h2 style={{textAlign:"center", paddingBottom:"10px", fontWeight:"normal"}}>No pierdas esta oportunidad única de ser parte de Barrio Cerrado Isla Bogado.</h2>
    </section>
    </>
  )
}
